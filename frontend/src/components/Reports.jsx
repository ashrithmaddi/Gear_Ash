    ...
    const fetchStats = async () => {
      try {
        const [
          ...
          axios.get("https://gearash-production.up.railway.app/api/admin/getTotalLecturers"),
          axios.get("https://gearash-production.up.railway.app/api/admin/getActiveLecturers"),
          axios.get("https://gearash-production.up.railway.app/api/admin/getTotalCourses"),
          axios.get("https://gearash-production.up.railway.app/api/admin/getActiveCourses"),
          axios.get("https://gearash-production.up.railway.app/api/reports/revenue"),
          axios.get("https://gearash-production.up.railway.app/api/admin/getCourseList"),
          axios.get("https://gearash-production.up.railway.app/api/reports/enrollment-stats"),
          axios.get("https://gearash-production.up.railway.app/api/reports/active-users"),
          axios.get("https://gearash-production.up.railway.app/api/categories"),
        ]);
        setStats({
